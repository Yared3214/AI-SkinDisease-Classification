...
const ExpertSignupScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="Medical License Number" value={licenseNumber} onChangeText={setLicenseNumber} />
      <TextInput style={styles.input} placeholder="Qualifications (e.g. MD, Dermatology)" value={qualifications} onChangeText={setQualifications} />
      <TextInput style={styles.input} placeholder="Workplace (Hospital/Clinic)" value={workplace} onChangeText={setWorkplace} />
